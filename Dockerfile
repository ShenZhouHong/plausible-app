...
# The tzdata library that Plausible depends on requires read/write access. Symlink it to /run/
...
RUN rm /app/code/plausible/lib/tzdata-1.1.1/priv/latest_remote_poll.txt \
